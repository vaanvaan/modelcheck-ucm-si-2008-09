...
public class SistemaActividades implements Interprete<EstadoTA> {
    ...
    public ItemGenerator itemGen = ItemGenerator.getReference();
    public ActividadGenerator activGen = ActividadGenerator.getReference();
    public String[] actividades;
    public String[] items;
    private ArrayList<String> l;
    private LinkedList<String> actividadesOrdenadas; // ordenadas en pre-orden
    private TreeMap<String, Set<String>> tabla;
    private List<EstadoTA> laux;

    public SistemaActividades(List<EstadoTA> laux) {
            this.laux = laux;
